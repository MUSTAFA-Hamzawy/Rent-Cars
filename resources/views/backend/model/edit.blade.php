...
@endsection
@section('page-title', trans('headers.edit_model'))
...
@section('breadcrumb-sub-titles')
    <li class="breadcrumb-item"><a href="{{route('model.index')}}"><i class="bx
                bx-home-alt"></i></a></li>
    <li class="breadcrumb-item active" aria-current="page">@lang('headers.edit_model')</li>
@endsection
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="border p-4 rounded">
                <div class="card-title d-flex align-items-center">
                    <h5 class="mb-0 text-info">@lang('headers.edit_model')</h5>
                </div>
                <hr>
                <form id="data-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <label for="model_name" class="col-sm-3 col-form-label">
                            @lang('model.name')<span class="required-star">*</span>
                        </label>
                        <div class="col-sm-9">
                            <input name="model_name" type="text" class="form-control" id="model_name" value="{{$item->model_name}}" required>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#data-form').on('submit', function (event) {
                ...
                $.ajax({
                    url: "{{ route('model.update', $item->id)}}",
                    method: 'POST',
                    data: formData,
                    headers: {
