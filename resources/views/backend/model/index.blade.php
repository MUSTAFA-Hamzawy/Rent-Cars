...
@section('page-title', trans('headers.models'))
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="ms-auto" style="margin-bottom: 20px">
                    <a href="{{route('model.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                        <i class="bx bxs-plus-square"></i>@lang('model.add')</a>
                </div>
                @if(count($data) > 0)
                    <div class="ms-auto" style="margin-bottom: 20px">
                        ...
                        <div class="modal fade" id="exampleVerticallycenteredModal2" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="{{route('model.truncate')}}">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            ...
                            <td style="width: 150px;">
                                <div class="d-flex order-actions">
                                    <a href="{{route('model.edit', $item->id)}}" class=""><i
                                    ...
                                    <!-- End Confirmation modal  -->
                                    <a href="{{route('model.show', $item->id)}}" class="ms-3"><i
