...
@section('page-title', $item->brand_name)
@section('breadcrumb-title', trans('Brands'))
@section('breadcrumb-sub-titles')
    <li class="breadcrumb-item"><a href="{{route('brand.index')}}"><i class="bx bx-home-alt"></i></a></li>
    <li class="breadcrumb-item active" aria-current="page">@lang('Brand')</li>
    <li class="breadcrumb-item active" aria-current="page">{{$item->brand_name}}</li>
@endsection
    @section('content')
        <div>
            <h3>@lang('Brand info')</h3>
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{asset($item->getLogoSrc())}}" alt="..." class="card-img">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h4 class="card-title">{{$item->brand_name}}</h4>
                                <dl class="row">
                                    ...
                                    <dt class="col-sm-3">@lang('Brand Description')</dt>
                                    <dd class="col-sm-9">{{$item->brand_description ??__('No Description')}}</dd>
                                </dl>
                        ...
                        <div class="card" style="padding: 15px">
                            <a href="{{route('car.show', $car->id)}}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="clearfix">
                                        <p class="mb-0 float-start"> <strong>@lang('Brand')</strong></p>
                                        <p class="mb-0 float-end fw-bold"><span>{{$car->brand->brand_name}} KM</span></p>
                                    </div>
                                    <div class="clearfix">
