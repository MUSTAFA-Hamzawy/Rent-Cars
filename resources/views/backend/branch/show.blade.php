...
@section('page-title', $item->branch_name)
@section('breadcrumb-title', trans('Branches'))
@section('breadcrumb-sub-titles')
    <li class="breadcrumb-item"><a href="{{route('branch.index')}}"><i class="bx bx-home-alt"></i></a></li>
    <li class="breadcrumb-item active" aria-current="page">@lang('Branch')</li>
    <li class="breadcrumb-item active" aria-current="page">{{$item->branch_name}}</li>
@endsection
@section('content')
    <div>
        <h3>@lang('Branch info')</h3>
        <div class="col">
            <div class="card">
                <div class="row g-0">
                    <div class="col-md-8">
                        <div class="card-body">
                            <h4 class="card-title">{{$item->branch_name}}</h4>
                            <dl class="row">
                            ...
                            <div class="d-flex gap-3 mt-3">
                                <a href="{{route('branch.edit', $item->id)}}" class="btn btn-warning">
                        ...
                        <div class="card" style="padding: 15px">
                            <a href="{{route('car.show', $car->id)}}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="clearfix">
                                        <p class="mb-0 float-start"> <strong>@lang('Branch')</strong></p>
                                        <p class="mb-0 float-end fw-bold"><span>{{$car->branch->branch_name}} KM</span></p>
                                    </div>
                                    <div class="clearfix">
