...
@endsection
@section('page-title', trans('headers.payment_method'))
...
@section('breadcrumb-sub-titles')
    <li class="breadcrumb-item"><a href="{{route('payment_method.index')}}"><i class="bx
                bx-home-alt"></i></a></li>
    <li class="breadcrumb-item active" aria-current="page">@lang('headers.add_payment_method')</li>
@endsection
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="border p-4 rounded">
                <div class="card-title d-flex align-items-center">
                    <h5 class="mb-0 text-info">@lang('headers.add_payment_method')</h5>
                </div>
                <hr>
                <form id="data-form" action="{{route('payment_method.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <label for="method_name" class="col-sm-3 col-form-label">
                            @lang('payment_method.name_placeholder')<span class="required-star">*</span>
                        </label>
                        <div class="col-sm-9">
                            <input name="method_name" type="text" class="form-control" id="method_name" placeholder="{{trans('payment_method.name_placeholder')}}" required>
